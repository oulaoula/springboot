...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${base}css/adminstyle.css" media="all">
</head>
<body>
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="welcome.action">
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-url="/PersonInfo?id=${activeUser.id}">
                            <i class="iconfont icon-geren1" data-icon='icon-geren1'></i>
                            <span>个人信息</span>
                        </a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-url="/PersonInfoUpdate?id=${activeUser.id}">
                ...
                <dl class="layui-nav-child">
                    <dd>
						<#if activeUser.role==1>
						     <a href="javascript:;" data-url="/log/allLogs">
                                 <i class="iconfont icon-iconfuzhi01" data-icon='icon-iconfuzhi01'></i>
                                 <span>日志查看</span>
                             </a>
						</#if>
						<#if activeUser.role==2>
						     <a href="javascript:;" data-url="/log/allLogsByMinister">
                                 <i class="iconfont icon-iconfuzhi01" data-icon='icon-iconfuzhi01'></i>
                                 <span>日志查看</span>
                             </a>
						</#if>
			...
			<#--<c:forEach items="${activeUser.menusroot}" var="menusroot">-->
			<#--<li class="layui-nav-item">-->
					<#--<a href="#">-->
					   <#--<i class="iconfont icon-jiaoseguanli2" ></i>-->
					   <#--<span>${menusroot.rightTip}</span>-->
					   <#--<em class="layui-nav-more"></em>-->
					<#--</a>-->
					    <#--<dl class="layui-nav-child">-->
							    <#--<c:forEach items="${activeUser.menus}" var="menus">-->
							    <#--<c:if test="${menus.rightParentCode== menusroot.rightCode}">-->
							    	<#--<dd>-->
							    		<#--<a href="#" data-url="${menus.rightUrl }">-->
							    		   <#--<i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>-->
							    		   <#--<span>${menus.rightTip}</span>-->
							    		<#--</a>-->
							    	<#--</dd>-->
							    	<#--</c:if>-->
							    <#--</c:forEach>-->
		...
		<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
			...
			<ul class="layui-nav closeBox">
				  <li class="layui-nav-item">
				    ...
				    <dl class="layui-nav-child">
					  <dd><a href="#" class="refresh refreshThis"><i class="layui-icon">&#x1002;</i> 刷新当前</a></dd>
				      <dd><a href="javascript:;" class="closePageOther  " ><i class="iconfont icon-prohibit layui-tab-close"></i> 关闭其他</a></dd>
...
<!-- 加载js文件-->                                                                                                                                                                                           
	...
	<script type="text/javascript" src="${base}js/larry.js"></script>
...
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		...
		<div class="lock-box center">
			<img src="${base}images/userimg.jpg" alt="">
			<h1>admin</h1>
