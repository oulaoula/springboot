...
<script type="text/javascript">
	function updateService(id){
		...
		window.location.href="updateService.action?svrId="+id;
                          ...
                          <tbody>
                             <c:forEach items="${custService}" var="custService">
                              <tr>
                                ...
                                <td>
                                	<a href="javascript:void(0)" onclick="updateService(${custService.svrId})" class="btn btn-default" data-toggle="modal" data-target="#myModal">修改</a>
                                	<a class="layui-btn layui-btn-normal newsAdd_btn" href="updateStatus.action?svrId=${custService.svrId}">提交</a>
                                </td>
                              </tr>
                         	 </c:forEach>
                          </tbody>
		...
		<%-- <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="doupdateService.action" method="post">
					<div class="modal-body">
						<input type="hidden" name="svrId" value="${updateCstService.svrId}">
						  <div class="layui-form-item">
						    <label class="layui-form-label">ID：</label>
						    <div class="layui-form-mid layui-word-aux">${updateCstService.svrId}</div>
						  </div>
						 <div class="layui-form-item">
						  ...
						  <div class="layui-form-item">
						    ...
						    <div class="layui-input-inline">
						      <input type="text" name="svrCustName" required lay-verify="required"  autocomplete="off" class="layui-input" value="${updateCstService.svrCustName}">
						   	 </div>
						  </div>
						  <div class="layui-form-item">
						    <label class="layui-form-label">服务状态：</label>
						    <div class="layui-form-mid layui-word-aux">${updateCstService.svrStatus}</div>
						  </div>
						  <div class="layui-form-item">
