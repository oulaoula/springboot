...
<section class="layui-larry-box">
	<div class="larry-personal">
	    <div class="layui-tab">
		        <form action="dogetServiceByStatusFourFinally.action" method="post"  class="layui-form layui-form-pane">
					<div class="modal-body">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="svrResult" required lay-verify="required" autocomplete="off" class="layui-input" value="${custService.svrResult}" >
							</div>
						</div>
						<input type="hidden" name="svrStatus" value="4"><!-- 已处理，将状态该改为4 -->
					</div>
					<div class="layui-form-item">
